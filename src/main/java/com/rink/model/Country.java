...
public class Country {
    ...
    //Some countries have multiple capitals, so the data is stored as a list of strings
    //For the purposes of this application, I am just using whichever capital is first on the list
    ...
    //Prints a list of languages spoken in the country
    //Prints the full language name, not the abbreviation
    ...
    //Wrapper class that maps the "callingCode" variable in the class to the "idd -> root" field in the JSON response
    @JsonIgnoreProperties(ignoreUnknown = true)
